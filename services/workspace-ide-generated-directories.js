...
const AMBIGUOUS_GENERATED_DIRECTORY_NAMES = new Set([
  "build",
  "dist",
  "out",
  "target",
...
function isAmbiguousGeneratedDirectoryName(
  name,
  { platform = process.platform } = {},
) {
  return AMBIGUOUS_GENERATED_DIRECTORY_NAMES.has(
    normalizeForPlatform(name, platform),
  );
}
...
function pruneAmbiguousGeneratedEntries(
  entries,
  { platform = process.platform } = {},
) {
